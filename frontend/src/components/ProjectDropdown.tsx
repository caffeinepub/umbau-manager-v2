...
export default function ProjectDropdown({ currentProjectId, onProjectSelect, onCreateNew }: ProjectDropdownProps) {
  ...
  return (
    <Select value={currentProjectId || undefined} onValueChange={handleValueChange}>
